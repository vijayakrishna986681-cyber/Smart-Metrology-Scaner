        ...
        with st.form("login_form"):
            ...
            if login_btn:
                if inspector_id and password == "sih2026":
                    ...
                    st.error("Invalid Inspector ID or Password! (Use password: sih2026)")
    st.stop()
...
if nav_choice == "Logout":
    ...
    # API Key Input
    gemini_api_key = st.sidebar.text_input("Enter Google Gemini API Key", type="password", help="Enter your Google Gemini API Key (starts with AQ.)")
    ...
    with col_analysis:
        ...
        run_check = st.button("Run Real Gemini AI Compliance Check", type="primary")
        ...
        if run_check:
            ...
            if not active_api_key:
                st.error("Please enter your Google Gemini API Key in the sidebar or secrets!")
                ...
                try:
                    ...
                    with st.spinner("Analyzing product label against Legal Metrology rules via Gemini AI..."):
                    ...
                    st.warning("Server is experiencing high demand. Please click 'Run Gemini AI Compliance Check' again immediately!")
