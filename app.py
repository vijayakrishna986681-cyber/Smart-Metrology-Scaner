...
# Page Configuration
st.set_page_config(
    page_title="Smart Legal Metrology Checker",
    page_icon="⚖️",
    layout="centered"
)

# Rules Dictionary for Categories
RULES = {
...
api_key_input = st.sidebar.text_input(
    ...
    type="password", 
    help="Enter your Google Gemini API Key (starts with AQ. or AIzaSy)"
)
...
def gemini_call_with_retry(client, image_bytes, mime_type, max_attempts=2):
    last_err = None
    # అత్యంత స్థిరంగా పనిచేసే జెమిని మోడల్స్ లిస్ట్
...
# Input Methods: Camera or File Uploader
